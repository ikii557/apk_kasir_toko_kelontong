        ...
        <div class="card">
            ...
            <div class="p-3 me-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nomor_transaksi" class="form-control" value="{{ old('$nomor_transaksi') }}" required>
                </div>
            ...
            <h4 class="p-4">Tambah detail  Transaksi</h4>
                ...
                <script>
                    ...
                    document.getElementById('add-item').addEventListener('click', function() {
                        ...
                        inputs.forEach(input => input.value = ''); // Clear all inputs in the cloned group
                        newItem.querySelector('.total-harga').value = ''; // Reset total price
